...
//        System.out.println("sidesArray[6] = " + sidesArray[6]); //we will get an error! OUT OF BOUNDS!!
        ...
        System.out.println("Hey good to see you today " + cohorts[0] + " students! Did you know that our upcoming cohort is going to be named " + cohorts[3] + "?");
...
//        myPets[4] = "Kevin";
        ...
        String[] myPets = {"Onyx", "Franny", "Warlow", "Trixie", "Kevin"};
